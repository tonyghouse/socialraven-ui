        ...
        <div className="items-start lg:grid lg:grid-cols-[13.75rem_1fr] lg:gap-14">
          ...
          <PublicCard className="min-w-0 overflow-hidden">
            <div className="divide-y divide-[var(--ds-gray-400)]">
              <section id="overview" className="space-y-4 px-7 py-8 md:px-8">
                ...
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                  ...
                  and purchases are processed through our checkout flow.
                </p>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="trials" className="space-y-4 px-7 py-8 md:px-8">
              ...
              <section id="renewals" className="space-y-4 px-7 py-8 md:px-8">
              ...
              <section id="eligible" className="space-y-5 px-7 py-8 md:px-8">
                ...
                <ul className="overflow-hidden rounded-xl border border-[var(--ds-gray-400)] bg-[var(--ds-gray-100)]">
                  {[
                    ...
                    <li
                      key={item}
                      className="border-b border-[var(--ds-gray-400)] px-4 py-3 text-copy-14 text-[var(--ds-gray-900)] last:border-b-0"
                    >
                      {item}
                    </li>
                  ))}
              ...
              <section id="non-refundable" className="space-y-5 px-7 py-8 md:px-8">
              ...
              <section id="consumer-rights" className="space-y-4 px-7 py-8 md:px-8">
              ...
              <section id="requests" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">
              ...
              <section id="timing" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">
