        ...
        <div className="items-start lg:grid lg:grid-cols-[220px_1fr] lg:gap-14">
          ...
          <div className="min-w-0 space-y-6">
            <PublicCard id="introduction" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">1. Introduction</h2>
            ...
            <PublicCard id="eligibility" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">2. Eligibility</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">To use Social Raven, you must:</p>
              <ul className="list-disc space-y-2 pl-6 text-[hsl(var(--foreground-muted))]">
                <li>
            ...
            <PublicCard id="account-registration" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">3. Account Registration &amp; Security</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="prohibited-content" className="space-y-5 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">4. Prohibited Content &amp; Conduct</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
              ...
              <PublicInsetCard className="space-y-3 p-5">
                <h3 className="font-semibold text-[hsl(var(--foreground))]">4.3 Illegal &amp; Harmful Activity</h3>
                <ul className="list-disc space-y-2 pl-6 text-sm text-[hsl(var(--foreground-muted))]">
              ...
              <PublicInsetCard className="space-y-3 p-5">
                <h3 className="font-semibold text-[hsl(var(--foreground))]">4.4 Platform Abuse &amp; Automation Misuse</h3>
                <ul className="list-disc space-y-2 pl-6 text-sm text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="acceptable-use" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">5. Acceptable Use</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="third-party-platforms" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">6. Third-Party Platforms</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="your-content" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">7. Your Content &amp; Licence</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
              ...
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">You represent and warrant that:</p>
              <ul className="list-disc space-y-2 pl-6 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="privacy" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">8. Privacy &amp; Data Protection</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="intellectual-property" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">9. Intellectual Property</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="subscriptions" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">10. Subscriptions &amp; Payments</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="termination" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">11. Termination</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="disclaimers" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">12. Disclaimers</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="limitation-of-liability" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">13. Limitation of Liability</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
              ...
              <ul className="list-disc space-y-1 pl-6 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="indemnification" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">14. Indemnification</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="governing-law" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">15. Governing Law &amp; Dispute Resolution</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="updates" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">16. Updates to These Terms</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
            ...
            <PublicCard id="general" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">17. General Provisions</h2>
              <ul className="list-disc space-y-2 pl-6 text-[hsl(var(--foreground-muted))]">
                <li>
            ...
            <PublicCard id="contact" className="space-y-4 p-8">
              <h2 className="text-xl font-semibold text-[hsl(var(--foreground))]">18. Contact</h2>
              <p className="leading-7 text-[hsl(var(--foreground-muted))]">
