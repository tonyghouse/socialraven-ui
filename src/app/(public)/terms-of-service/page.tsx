        ...
        <div className="items-start lg:grid lg:grid-cols-[13.75rem_1fr] lg:gap-14">
          ...
          <PublicCard className="min-w-0 overflow-hidden">
            <div className="divide-y divide-[var(--ds-gray-400)]">
              <section id="introduction" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">1. Introduction</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                  Welcome to <strong>Social Raven</strong> (&quot;the Service&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;).
                  These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between you
                  (&quot;User&quot;, &quot;you&quot;) and Social Raven and govern your access to and use of our
                  social media scheduling and management platform, including all related tools, features,
                ...
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                  ...
                  <a href="/privacy-policy" className="text-[var(--ds-blue-600)] underline underline-offset-2">
                    Privacy Policy
                  </a>
              ...
              <section id="eligibility" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">2. Eligibility</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">To use Social Raven, you must:</p>
              ...
              <section id="account-registration" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">3. Account Registration &amp; Security</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="prohibited-content" className="space-y-5 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">4. Prohibited Content &amp; Conduct</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                ...
                <PublicInsetCard className="space-y-3 p-5">
                  <h3 className="text-heading-16 text-[var(--ds-gray-1000)]">4.3 Illegal &amp; Harmful Activity</h3>
                  <ul className="list-disc space-y-2 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
                ...
                <PublicInsetCard className="space-y-3 p-5">
                  <h3 className="text-heading-16 text-[var(--ds-gray-1000)]">4.4 Platform Abuse &amp; Automation Misuse</h3>
                  <ul className="list-disc space-y-2 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="acceptable-use" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">5. Acceptable Use</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="third-party-platforms" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">6. Third-Party Platforms</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="your-content" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">7. Your Content &amp; Licence</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                ...
                <p className="text-copy-14 text-[var(--ds-gray-900)]">You represent and warrant that:</p>
                <ul className="list-disc space-y-2 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="privacy" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">8. Privacy &amp; Data Protection</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="intellectual-property" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">9. Intellectual Property</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="subscriptions" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">10. Subscriptions &amp; Payments</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                ...
                <ul className="list-disc space-y-2 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
                  ...
                  <li>Current public plan prices are published on our <a href="/pricing" className="text-[var(--ds-blue-600)] underline underline-offset-2">pricing page</a>;</li>
                  ...
                  <li>Refund eligibility after that 14-day window is governed by our <a href="/refund-policy" className="text-[var(--ds-blue-600)] underline underline-offset-2">Refund Policy</a>, except where stricter consumer rights apply by law;</li>
              ...
              <section id="termination" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">11. Termination</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="disclaimers" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">12. Disclaimers</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="limitation-of-liability" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">13. Limitation of Liability</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
                ...
                <ul className="list-disc space-y-1 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="indemnification" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">14. Indemnification</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="governing-law" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">15. Governing Law &amp; Dispute Resolution</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="updates" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">16. Updates to These Terms</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
              ...
              <section id="general" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">17. General Provisions</h2>
                <ul className="list-disc space-y-2 pl-6 text-copy-14 text-[var(--ds-gray-900)]">
                  <li>
              ...
              <section id="contact" className="space-y-4 px-7 py-8 md:px-8">
                <h2 className="text-heading-16 text-[var(--ds-gray-1000)]">18. Contact</h2>
                <p className="text-copy-14 text-[var(--ds-gray-900)]">
